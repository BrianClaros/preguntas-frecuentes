...
<div class="container">
  <div class="jumbotron">
    <h1>Solicitudes</h1>
    <div class="row" style="">
        <div class="col-md-9 col-xs-7" style="border-bottom:1px solid black;background:rgba(200,200,200,.4);">
          <h5 class="h4">Preguntas</h5>
        </div>

        <div class="col-md-3 col-xs-5" style="border-bottom:1px solid black;background:rgba(200,200,200,.4);">
          <h5 class="h4">Acciones</h5>
        </div>
    </div>
